-- using 1496215618 as a seed to the RNG
...
from
	lineitem
where
	l_shipdate <= date '1998-12-01' - interval '119' day (3)
group by
	l_returnflag,
	l_linestatus
order by
...
from
	(
		...
		where
			...
			and (
				(n1.n_name = 'RUSSIA' and n2.n_name = 'MOZAMBIQUE')
				or (n1.n_name = 'MOZAMBIQUE' and n2.n_name = 'RUSSIA')
			)
...
where
	...
	and p_size in (36, 15, 14, 35, 49, 6, 33, 44)
